...
![Version: 3.42.4](https://img.shields.io/badge/Version-3.42.4-informational?style=flat-square) ![AppVersion: 2.332.2.4](https://img.shields.io/badge/AppVersion-2.332.2.4-informational?style=flat-square)
...
| Agents.Image.dockerImage | string | `"cloudbees/cloudbees-core-agent:2.332.2.4"` | Used to override the default docker image used for agents |
...
| Master.Image.dockerImage | string | `"cloudbees/cloudbees-core-mm:2.332.2.4"` | Used to override the default docker image |
...
| OperationsCenter.Image.dockerImage | string | `"cloudbees/cloudbees-cloud-core-oc:2.332.2.4"` | Container image to use for Operations Center |
