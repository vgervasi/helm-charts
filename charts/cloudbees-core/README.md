...
| Agents.Image.dockerImage | string | `"cloudbees/cloudbees-core-agent:2.332.1.5"` | Used to override the default docker image used for agents |
...
| Master.Image.dockerImage | string | `"cloudbees/cloudbees-core-mm:2.332.1.5"` | Used to override the default docker image |
