...
![Version: 3.45.1](https://img.shields.io/badge/Version-3.45.1-informational?style=flat-square) ![AppVersion: 2.346.2.2](https://img.shields.io/badge/AppVersion-2.346.2.2-informational?style=flat-square)
...
| Agents.Image.dockerImage | string | `"cloudbees/cloudbees-core-agent:2.346.2.2"` | Used to override the default docker image used for agents |
...
| Master.Image.dockerImage | string | `"cloudbees/cloudbees-core-mm:2.346.2.2"` | Used to override the default docker image |
...
| OperationsCenter.Image.dockerImage | string | `"cloudbees/cloudbees-cloud-core-oc:2.346.2.2"` | Container image to use for Operations Center |
